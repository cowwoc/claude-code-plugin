...
- Types: feature, bugfix, test, refactor, performance, config
- Each commit includes implementation + planning metadata (STATE.md)
- Final task commit also includes SUMMARY.md and ROADMAP.md
