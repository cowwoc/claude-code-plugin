...
# Optional metadata
effort: "1-2 hours"
parallelizable-with: ["02-02", "02-03"]
---
...
<task type="auto" id="task-002" depends-on="task-001">
...
<task type="auto" id="add-user-model">
...
<task type="auto" id="create-login-endpoint" depends-on="add-user-model">
