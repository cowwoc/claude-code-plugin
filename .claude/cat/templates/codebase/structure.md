...
**New Slash Command:**
- Primary code: `commands/cat/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `cat/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `cat/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/cat/workflows/{name}.md`

**New Reference Document:**
- Implementation: `cat/references/{name}.md`
