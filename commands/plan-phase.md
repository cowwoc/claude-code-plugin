...
<execution_context>
@${CLAUDE_PLUGIN_ROOT}/.claude/cat/workflows/plan-phase.md
@${CLAUDE_PLUGIN_ROOT}/.claude/cat/templates/phase-prompt.md
@${CLAUDE_PLUGIN_ROOT}/.claude/cat/references/plan-format.md
...
**Load phase context if exists (created by /cat:discuss-phase):**
