...
1. Stage implementation files modified by that task
2. Stage planning metadata: STATE.md (update task status)
3. For final task: also stage SUMMARY.md, ROADMAP.md updates
4. Commit with format: `{type}: {task-name}`
5. Types: feature, bugfix, test, refactor, performance, config
6. Record commit hash for SUMMARY.md
...
See ${CLAUDE_PLUGIN_ROOT}/.claude/cat/references/git-integration.md for full commit strategy.
</commit_rules>
