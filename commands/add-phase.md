...
- Example: `/cat:add-phase Add authentication` → description = "Add authentication"
- Example: `/cat:add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /cat:add-phase <description>
Example: /cat:add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /cat:plan-phase {N} to break down)
...
**Also available:**
- `/cat:add-phase <description>` — add another phase
- Review roadmap
...
- Don't use decimal numbering (that's /cat:insert-phase)
- Don't create plans yet (that's /cat:plan-phase)
