...
- @${CLAUDE_PLUGIN_ROOT}/.claude/cat/workflows/complete-milestone.md (main workflow)
- @${CLAUDE_PLUGIN_ROOT}/.claude/cat/templates/milestone-archive.md (archive template)
  </execution_context>
